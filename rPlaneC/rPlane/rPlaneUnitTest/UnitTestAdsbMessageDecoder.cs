...
namespace rPlaneUnitTest
{
    ...
    public class UnitTestAdsbMessageDecoder
    {
        ...
        {
           // var plane = new AircraftPosition("8D40621D58C382D690C8AC2863A7", "8D40621D58C386435CC412692AD6");
            //plane.GetLatitude();
           // plane.GetLongitude();
            ...
            //var lat = latitude.GetLatitudeLongitude("8D40621D58C382D690C8AC2863A7", "8D40621D58C386435CC412692AD6");
            // Assert.AreEqual(52.2572021484375, lat, $"Result is not as expected. Got: {lat}, expected: 52.2572021484375");
        }
    }
}